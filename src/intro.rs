...
pub fn IntroLesson() -> impl IntoView {
    view! {
        ...
        <section class="content-section primer-section">
            ...
            <p class="section-copy">"A byte is a number from 0 through 255: 256 possible values. Text, images, and files must all be encoded as bytes before a cryptographic algorithm can process them. In this course, text is encoded as UTF-8."</p>
