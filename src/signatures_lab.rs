    ...
    view! {
        <section class="workbench">
            <div class="workbench-heading">
                <div><h2>"Sign and verify with Ed25519."</h2></div>
                <p>"The message is visible before a key exists. Generate a signing keypair to enable signing, then verify the exact message and a changed version."</p>
            </div>
            ...
            <div class="workbench-quiz">
                ...
                <div class="mini-workbench">
                    ...
                    >"Sign message"</button>
                    <p class="field-note">{move||if pair.get().is_none(){"Generate a signing keypair to enable signing."}else{"The private key is ready to sign."}}</p>
                    <div class="output">
        ...
        <section id="signature-exercises" class="content-section planned-quiz">
            ...
            <div class="workbench-quiz">
                ...
                <h3>"Verify the current message against the signature."</h3>
                <button
                    type="button"
            ...
            <div class="workbench-quiz">
                ...
                <div class="hero-actions">
                    <button type="button" disabled=move||!signed_seen.get() on:click=move |_|set_message.update(|m|m.push('!'))>"Add one character"</button>
                    <button
                        type="button"
                        disabled=move||!signed_seen.get()
                        on:click=move |_| {
